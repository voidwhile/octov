...
- **🎵 音乐播放器** — QQ 音乐风格沉浸式布局，双列设计，黑胶唱片旋转动画
- **📜 动态歌词** — 自动搜索网易云音乐歌词，支持手动滚动与自动同步
- **📋 播放列表** — 右侧毛玻璃列表抽屉，支持一键切歌
- **⚡ 智能路由** — 自动识别音乐与视频格式，无缝切换播放模式
- **🌙 深色模式** — 浅色/深色/跟随系统主题切换
- **🧹 缓存管理** — 一键清理视频缓冲、图片缓存及音频临时文件
...
| `octov-audio-cache/` | (临时目录) 云盘音乐本地缓存 |
